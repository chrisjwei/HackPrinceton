...
curl_setopt($connection, CURLOPT_CAINFO, "path:/Applications/XAMPP/htdocs/hack/ca-bundle.crt");
...
$nonce = time();
$timestamp = time();
$oauth = array('oauth_callback' => 'http://about.me/arielrao',
              'oauth_consumer_key' => 'ALMRmXKozjinNoL8Qk01DbDXw',
              'oauth_nonce' => $nonce,
...
$consumerSecret = '***'; //put your actual consumer secret here, it will look something like 'MCD8BKwGdgPHvAuvgvz4EQpqDAtx89grbuNMRd7Eh98'
